...
def make_google_maps_urls(start_name, end_name, config):
    ...
    origin = f"{start_name} MRT station {area}"
    ...
    st.markdown(
        ...
        <div class="google-map-float">
            <details open>
                ...
                <div class="google-map-route">{escape(start_name)} 到 {escape(end_name)}</div>
                <iframe
                ...
                <div class="google-map-actions">
                    ...
                    <a class="secondary" href="{escape(search_url, quote=True)}" target="_blank" rel="noopener noreferrer">查看目的地</a>
                </div>
            </details>
        </div>
        """,
